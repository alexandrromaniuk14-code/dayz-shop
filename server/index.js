...
const productDeliveryCatalog = {
  ...
  "Газ 2705": { type: "vehicle", className: "C_Gaz2705_Khaki" },
  "Дефендер": { type: "vehicle", className: "bastard_defender_black" },
  "Хамви": { type: "vehicle", className: "bastard_humvee_green" },
  "Уаз 31514": { type: "vehicle", className: "bastard_Uaz31514_stock" },
  "Уаз 469": { type: "vehicle", className: "bastard_uaz_green" },
  "Буханка": { type: "vehicle", className: "bastard_uaz452_stock" },
  "Volkswagen T4": { type: "vehicle", className: "bastard_t4_yellow" },
  "Мотоцикл Днепр": { type: "vehicle", className: "bastard_dnepr_green" },
  "Квадроцикл": { type: "vehicle", className: "bastard_quadbike_black" },
  "Мотоцикл ИЖ": { type: "vehicle", className: "bastard_izh_black" },
